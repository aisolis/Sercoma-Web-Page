   ...
   <div class="col-md-12">
      <div class="card">
         <div class="card-header">
            <div class="card-title">Crear Página</div>
         </div>
               ...
               <div class="col-lg-10 offset-lg-1">
                  <form id="ajaxForm" action="{{route('admin.page.store')}}" method="post">
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-4">
                           <div class="form-group">
                              ...
                              <input type="text" name="name" class="form-control" placeholder="Ingrese un nombre" value="">
                        ...
                        <div class="col-lg-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="subtitle" placeholder="Ingrese un sub titulo" value="">
                     ...
                     <div class="form-group">
                        ...
                        <input class="form-control" name="meta_keywords" value="" placeholder="Ingresa palabras clave" data-role="tagsinput">
                     </div>
                     <div class="form-group">
