...
@section('content')
  <div class="mt-2 mb-4">
    <h2 class="text-white pb-2">¡Bienvenido/a de vuelta, {{Auth::guard('admin')->user()->first_name}} {{Auth::guard('admin')->user()->last_name}}!</h2>
  </div>
  <div class="row">
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-7 col-stats">
							<div class="numbers">
								<p class="card-category">Miembros del equipo</p>
    		...
    		<div class="col-md-12">
    			<div class="card">
    				<div class="card-header">
    					...
    					Top 10 de ultimas cotizaciones</p>
    				</div>
    				<div class="card-body">
              <div class="row">
                  <div class="col-lg-12">
                      @if (count($quotes) == 0)
                      <h3 class="text-center">No se han encontrado cotizaciones</h3>
                      @else
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="ajaxEditForm" class="" action="{{route('admin.quotes.mail')}}" method="POST">
            ...
            <div class="form-group">
              ...
              <input id="inemail" type="text" class="form-control" name="email" value="" placeholder="Ingrese un correo del cliente">
            ...
            <div class="form-group">
              ...
              <textarea id="inmessage" class="form-control nic-edit" name="message" rows="5" cols="80" placeholder="Ingrese un mensaje"></textarea>
        ...
        <div class="modal-footer">
          ...
          <button id="updateBtn" type="button" class="btn btn-primary">Enviar email</button>
        </div>
      </div>
    </div>
  </div>
