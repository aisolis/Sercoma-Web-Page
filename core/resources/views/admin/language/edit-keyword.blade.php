...
@section('content')
  <div class="page-header">
    <h4 class="page-title">Editar palabras claves</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">Editar palabras claves</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">Editar palabras claves del idioma</div>
          ...
          <div class="form">
            <div class="form-group from-show-notify row">
              <div class="col-12 text-center">
                <button type="button" class="btn btn-success" onclick="document.getElementById('langForm').submit();">Actualizar</button>
              </div>
            </div>
          </div>
        </div>
