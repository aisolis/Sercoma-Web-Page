...
@section('content')
  <div class="page-header">
    <h4 class="page-title">Galeria de imágenes</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">Administrador de galeria de imágenes</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-title d-inline-block">Galeria de imágenes</div>
                </div>
                <div class="col-lg-3">
                    @if (!empty($langs))
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> Agregar imágen</a>
                    <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{route('admin.gallery.bulk.delete')}}"><i class="flaticon-interface-5"></i> Eliminar</button>
                </div>
            </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($galleries) == 0)
                <h3 class="text-center">No se encontrarón imágenes</h3>
              @else
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Agregar Imágen</h5>
        ...
        <div class="modal-body">
          ...
          <form id="ajaxForm" class="modal-form" action="{{route('admin.gallery.store')}}" method="POST">
            ...
            <div class="form-group">
              ...
              <p class="text-warning"><small>Cuanto mayor sea el número de serie, más tarde se mostrará la imagen.</small></p>
            </div>
          </form>
        </div>
