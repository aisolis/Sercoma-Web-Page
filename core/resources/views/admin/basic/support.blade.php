...
@section('content')
  <div class="page-header">
    <h4 class="page-title">Informaciones de soporte</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">Informaciones de soporte</a>
      </li>
    </ul>
  </div>
  <div class="row">
      ...
      <div class="card">
        <form class="mb-3 dm-uploader drag-and-drop-zone" enctype="multipart/form-data" action="{{route('admin.support.update', $lang_id)}}" method="POST">
          <div class="card-header">
              <div class="row">
                  <div class="col-lg-10">
                      <div class="card-title">Cambiar información</div>
                  </div>
                  <div class="col-lg-2">
                      @if (!empty($langs))
            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="support_phone" value="{{$abs->support_phone}}" placeholder="Teléfono">
