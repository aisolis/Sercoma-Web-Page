      ...
      <div class="card">
        <form id="socialForm" action="{{route('admin.social.store')}}" method="post" onsubmit="store(event)">
          <div class="card-header">
            <div class="card-title">Añadir Link sociales</div>
          </div>
            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  ...
                  @endif
                  <div class="mt-2">
                    <small>Nota: Haga clic en el icono desplegable para seleccionar un icono para el enlace social.</small>
                  </div>
                </div>
                <div class="form-group">
                  <label for="">URL **</label>
                  <input type="text" class="form-control" name="url" value="" placeholder="Ingrese la URL de la cuenta de redes sociales">
                  @if ($errors->has('url'))
            ...
            <div class="form">
              <div class="form-group from-show-notify row">
                ...
                <div class="col-12 text-center">
                  <button type="submit" id="displayNotif" class="btn btn-success">¡Listo!</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($socials) == 0)
                <h2 class="text-center">No hay links añadidos</h2>
              @else
