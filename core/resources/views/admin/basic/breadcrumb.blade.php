    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-10">
                    <div class="card-title">Actualizar Breadcrumb</div>
                </div>
                <div class="col-lg-2">
                    @if (!empty($langs))
                ...
                <div class="form-row">
                  ...
                  <div class="col-sm-12">
                    <div class="from-group mb-2">
                      <input type="text" class="form-control progressbar" aria-describedby="fileHelp" placeholder="Ninguna imagen se ha subido..." readonly="readonly" />
                    ...
                    <div class="mt-4">
                      <div role="button" class="btn btn-primary mr-2">
                        ...
                        <input type="file" title='Haga clic para agregar archivos' name="breadcrumb" />
                      </div>
