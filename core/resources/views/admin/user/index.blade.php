    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">Usuarios</div>
          <a href="#" class="btn btn-primary float-right" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> Agregar usuario</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
                      ...
                      @foreach ($users as $key => $user)
                        @if ($user->id != Auth::guard('admin')->user()->id)
                          <tr>
                            ...
                            <td>
                              @if (empty($user->role))
                                <span class="badge badge-danger">Dueño</span>
                              @else
                                {{$user->role->name}}
                              @endif
                            </td>
