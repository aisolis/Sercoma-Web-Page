    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Agregar Slider</h5>
        ...
        <div class="modal-body">
          ...
          <form class="modal-form" id="ajaxForm" action="{{route('admin.slider.store')}}" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="text" value="" placeholder="Ingrese un Texto">
              <p id="errtext" class="mb-0 text-danger em"></p>
            </div>
            <div class="form-group">
              <label for="">Texto del botón </label>
              <input type="text" class="form-control" name="button_text" value="" placeholder="Ingrese un texto para el botón">
              <p id="errbutton_text" class="mb-0 text-danger em"></p>
            </div>
            <div class="form-group">
              <label for="">URL del Botón </label>
              <input type="text" class="form-control ltr" name="button_url" value="" placeholder="Ingrese una URL">
