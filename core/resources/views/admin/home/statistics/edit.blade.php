...
@section('content')
  <div class="page-header">
    <h4 class="page-title">Sección de Estadística</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">Sección de Estadística</a>
      </li>
    </ul>
  </div>
  <div class="row">
      ...
      <div class="card">
        <form id="statisticForm" action="{{route('admin.statistics.update')}}" method="post">
          <div class="card-header">
            <div class="card-title d-inline-block">Editar Estadísticas</div>
            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="title" value="{{$statistic->title}}" placeholder="Ingrese un titulo">
                  @if ($errors->has('title'))
                ...
                <div class="form-group">
                   ...
                   <div class="input-group @if(!empty($selLang) && $selLang->rtl == 1) rtl @endif">
                      <input type="text" class="form-control" name="quantity" value="{{$statistic->quantity}}" placeholder="Ingrese la cantidad" aria-describedby="basic-addon2">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control ltr" name="serial_number" value="{{$statistic->serial_number}}" placeholder="Ingrese el numero de serie">
