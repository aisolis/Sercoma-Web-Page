...
@section('content')
  <div class="page-header">
    <h4 class="page-title">Sección de Estadísticas</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">Sección de Estadísticas</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-title d-inline-block">Estadísticas</div>
                </div>
                <div class="col-lg-3">
                    @if (!empty($langs))
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="#" class="btn btn-primary float-lg-right float-left" data-toggle="modal" data-target="#createStatisticModal"><i class="fas fa-plus"></i> Agregar Estadística</a>
                </div>
            </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($statistics) == 0)
                <h2 class="text-center">No existen estadísticas</h2>
              @else
