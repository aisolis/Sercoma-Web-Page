...
@section('content')
  <div class="page-header">
    <h4 class="page-title">Enviar un correo a suscriptores</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">Enviar un correo a suscriptores</a>
      </li>
    </ul>
  </div>
  <div class="row">
      ...
      <div class="card">
        <form class="" action="{{route('admin.subscribers.sendmail')}}" method="post">
          ...
          <div class="card-header">
            <div class="card-title">Enviar un correo</div>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-lg-8 offset-lg-2">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="subject" value="" placeholder="Ingrese el asunto del correo">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="message" class="summernote"><?php echo"<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
<html style='width:100%;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0;'>
 <head> 
  ...
  <title>ha querido contactarse con Sercoma</title> 
                  ...
                  <tbody><tr style='border-collapse:collapse;'> 
                   <td width='560' align='center' valign='top' style='padding:0;Margin:0;'> 
                    <table cellpadding='0' cellspacing='0' width='100%' role='presentation' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;'> 
                      <tbody><tr style='border-collapse:collapse;'> 
                       <td align='center' style='padding:0;Margin:0;padding-left:10px;font-size:0px;'><a target='_blank' href='https://stripo.email' style='-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, ' helvetica='' neue',='' helvetica,='' arial,='' sans-serif;font-size:14px;text-decoration:underline;color:#1376c8;'=''><img src='https://iilwpf.stripocdn.email/content/guids/CABINET_11eef3b988e0a2dda44303d4ff9a5713/images/81071590787560145.png' alt='' style='display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;width:236px;height:117px;' width='236' class='adapt-img'></a></td> 
                      </tr> 
                 ...
                 <tbody><tr style='border-collapse:collapse;'> 
                  <td width='540' align='center' valign='top' style='padding:0;Margin:0;'> 
                   <table cellpadding='0' cellspacing='0' width='100%' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left bottom;' role='presentation'> 
                     <tbody><tr style='border-collapse:collapse;'> 
                      <td align='center' style='padding:0;Margin:0;'><h1 style='Margin:0;line-height:55px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:46px;font-style:normal;font-weight:bold;color:#212121;'>Sercoma CAS - Epson</h1></td> 
                     </tr> 
                     <tr style='border-collapse:collapse;'> 
         ...
         <tbody><tr style='border-collapse:collapse;'> 
          <td align='center' style='padding:0;Margin:0;'> 
           <table bgcolor='#31cb4b' class='es-footer-body' align='center' cellpadding='0' cellspacing='0' width='600' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;'> 
             <tbody><tr style='border-collapse:collapse;'> 
              <td align='left' style='padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;'><h1><br></h1><table cellpadding='0' cellspacing='0' width='100%' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;'><tbody> 
               </tbody></table></td> 
             </tr> 
             <tr style='border-collapse:collapse;'> 
