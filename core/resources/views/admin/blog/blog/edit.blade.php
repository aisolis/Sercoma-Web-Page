    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">Editar Blog</div>
            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" class="" action="{{route('admin.blog.update')}}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="title" value="{{$blog->title}}" placeholder="Ingresa un titulo">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control summernote" name="content" data-height="300" placeholder="Ingresa contenido">{{$blog->content}}</textarea>
                  <p id="errcontent" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="">Número de serie **</label>
                  <input type="number" class="form-control ltr" name="serial_number" value="{{$blog->serial_number}}" placeholder="Ingresa un número de serie">
                  <p id="errserial_number" class="mb-0 text-danger em"></p>
                  <p class="text-warning"><small>Cuanto mayor sea el número de serie, más tarde se mostrará el blog.</small></p>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="">Descripciones meta</label>
