        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> Agregar categoria</a>
                    <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{route('admin.scategory.bulk.delete')}}"><i class="flaticon-interface-5"></i> Eliminar</button>
                </div>
            </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($scategorys) == 0)
                <h3 class="text-center">No se han encontrado categorias de servicio</h3>
              @else
                  ...
                  <table class="table table-striped mt-3">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Imágen del icono</th>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Agregar categoria de servicio</h5>
        ...
        <div class="modal-body">
          <form class="mb-3 dm-uploader drag-and-drop-zone modal-form" enctype="multipart/form-data" action="{{route('admin.scategory.upload')}}" method="POST">
            <div class="form-row px-2">
              <div class="col-12 mb-2">
                <label for=""><strong>Imágen de icono **</strong></label>
              </div>
              ...
              <div class="col-sm-12">
                ...
                <div class="mt-4">
                  <div role="button" class="btn btn-primary mr-2">
                    ...
                    <input type="file" title='Haga clic para agregar archivos' name="service_category_icon" />
                  </div>
          ...
          <form id="ajaxForm" class="modal-form" action="{{route('admin.scategory.store')}}" method="POST">
            ...
            <div class="form-group">
              ...
              <p class="text-warning"><small>Cuanto mayor sea el número de serie, más tarde se mostrará la categoría de servicio en todas partes.</small></p>
            </div>
          </form>
        </div>
