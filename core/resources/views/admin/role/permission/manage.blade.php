                  ...
                  <label for="">Permisos: </label>
                	<div class="selectgroup selectgroup-pills mt-2">
                		...
                		<label class="selectgroup-item">
                			...
                			<span class="selectgroup-button">Configuraicones Básicas</span>
                		</label>
                		<label class="selectgroup-item">
                		...
                		<label class="selectgroup-item">
                			...
                			<span class="selectgroup-button">Página de inicio</span>
                		</label>
                		<label class="selectgroup-item">
                			...
                			<span class="selectgroup-button">Pie de página</span>
                		</label>
                		<label class="selectgroup-item">
                			...
                			<span class="selectgroup-button">Páginas</span>
                		</label>
                		<label class="selectgroup-item">
                			...
                			<span class="selectgroup-button">Página de servicios</span>
                		</label>
                		<label class="selectgroup-item">
                		...
                		<label class="selectgroup-item">
                			...
                			<span class="selectgroup-button">Página de carrera</span>
                		</label>
                		<label class="selectgroup-item">
                		...
                		<label class="selectgroup-item">
                			...
                			<span class="selectgroup-button">Página de contacto</span>
                		</label>
                		<label class="selectgroup-item">
