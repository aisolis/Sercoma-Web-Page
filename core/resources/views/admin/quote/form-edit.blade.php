...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">Constructuro de formularios</a>
      </li>
    </ul>
  </div>
          ...
          <div class="card-title">
              <div class="row">
                  ...
                  <div class="col-lg-6 text-right">
                    <a class="btn btn-primary" href="{{route('admin.quote.form') . '?language=' . request()->input('language')}}">volver</a>
                  </div>
              </div>
          </div>
        </div>
                    ...
                    <form id="ajaxForm" action="{{route('admin.quote.inputUpdate')}}" method="post" enctype="multipart/form-data">
                        ...
                        @if ($input->type != 3 && $input->type != 5)
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input type="text" class="form-control" name="placeholder" value="{{$input->placeholder}}" placeholder="Texto del campo">
                                </div>
                        ...
                        @if ($input->type == 2 || $input->type == 3)
                            <div class="form-group">
                                <label for=""><strong>Optciones</strong></label>
                                <div class="row mb-2 counterrow" v-for="n in counter" :id="'counterrow'+n">
                                <div class="col-md-11">
                                    <input class="form-control optionin" type="text" name="options[]" :value="names[n-1]" placeholder="opciones de etiquetas">
                                </div>
                        ...
                        <button id="submitBtn" type="submit" class="btn btn-primary">Actualizar campos</button>
                        </div>
                    </form>
                </div>
            </div>
