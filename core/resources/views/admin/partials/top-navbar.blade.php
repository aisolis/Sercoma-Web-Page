              ...
              <li>
                <div class="user-box">
                  ...
                  <div class="u-text">
                    ...
                    <p class="text-muted">{{Auth::guard('admin')->user()->email}}</p><a href="{{route('admin.editProfile')}}" class="btn btn-xs btn-secondary btn-sm">Editar Perfil</a>
                  </div>
                </div>
              </li>
              <li>
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{route('admin.changePass')}}">Cambiar contraseña</a>
                <div class="dropdown-divider"></div>
