         ...
         <div class="modal-body">
            <form id="ajaxForm" class="modal-form" action="{{route('admin.package.store')}}" method="POST">
               ...
               <div class="form-group">
                  ...
                  <textarea class="form-control summernote" name="description" rows="8" cols="80" placeholder="Ingresa una descripción" data-height="300"></textarea>
               ...
               <div class="form-group">
                  ...
                  <p class="text-warning"><small>Cuanto mayor sea el número de serie, más tarde se mostrará el paquete en todas partes.</small></p>
               </div>
               <div class="form-group">
         ...
         <div class="modal-body">
            <form id="ajaxEditForm" class="" action="{{route('admin.package.update')}}" method="POST">
               ...
               <div class="form-group">
                  ...
                  <textarea id="indescription" class="form-control summernote" name="description" placeholder="Ingrese una descripción" data-height="200"></textarea>
