          ...
          <div class="card-title">
              <div class="row">
                  ...
                  <div class="col-lg-6 text-right">
                    <a class="btn btn-primary" href="{{route('admin.package.form') . '?language=' . request()->input('language')}}">Volver</a>
                  </div>
              </div>
          </div>
        </div>
        ...
        <div class="card-body">
            <div class="row" id="app">
                ...
                <div class="col-lg-6 offset-lg-3">
                    <form id="ajaxForm" action="{{route('admin.package.inputUpdate')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        @if ($input->type != 5)
                        <div class="form-group">
                            <label for=""><strong>Etiqueta de nombre</strong></label>
                            <div class="">
                            <input type="text" class="form-control" name="label" value="{{$input->label}}" placeholder="Ingrese una Etiqueta de nombre">
                            </div>
                        ...
                        @if ($input->type != 3 && $input->type != 5)
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input type="text" class="form-control" name="placeholder" value="{{$input->placeholder}}" placeholder="Ingrese texto de campo">
                                </div>
                        ...
                        @if ($input->type == 2 || $input->type == 3)
                            <div class="form-group">
                                ...
                                <div class="col-md-11">
                                    <input class="form-control optionin" type="text" name="options[]" :value="names[n-1]" placeholder="Etiqueta de opción">
                                </div>
                        ...
                        <button id="submitBtn" type="submit" class="btn btn-primary">Actualizar campo</button>
                        </div>
                    </form>
                </div>
            </div>
...
@section('vuescripts')
  <script>
    var app = new Vue({
      ...
      created() {
        $.get("{{route('admin.package.options', $input->id)}}", (data) => {
