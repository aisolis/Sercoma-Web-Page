  ...
  <div class="row" id="app">
    <div class="col-lg-7">
      <div class="card">
        ...
        <div class="card-body">
            <p class="text-warning">** No crear <strong class="text-danger">Nombre y Correo Electronico</strong> estos campos de entrada, estarán en el formulario de pedido de paquete de forma predeterminada.</p>
    ...
    <div class="col-lg-5">
      <div class="card">
        ...
        <form id="ajaxForm" action="{{route('admin.package.form.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="">
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="inlineRadio1">Texto del campo</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input name="type" class="form-check-input" type="radio" id="inlineRadio2" value="2" v-model="type" @change="typeChange()">
                        <label class="form-check-label" for="inlineRadio2">Elige</label>
                    </div>
                    <div class="form-check form-check-inline">
            ...
            <div class="form-group">
                <label for=""><strong>Nombre de la etiqueta</strong></label>
                <div class="">
                    <input type="text" class="form-control" name="label" value="" placeholder="ingresa un Nombre para la etiqueta">
                </div>
                <p id="errlabel" class="mb-0 text-danger em"></p>
            </div>

            <div class="form-group" v-if="placeholdershow">
                <label for=""><strong>Texto del campo</strong></label>
                <div class="">
                    <input type="text" class="form-control" name="placeholder" value="" placeholder="Ingresa un Texto para el campo">
                </div>
