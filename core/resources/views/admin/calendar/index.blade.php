    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-title d-inline-block">Calendario de Eventos</div>
                </div>
                <div class="col-lg-3">
                    @if (!empty($langs))
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> agregar evento</a>
                    <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{route('admin.calendar.bulk.delete')}}"><i class="flaticon-interface-5"></i> Eliminar</button>
                </div>
            </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($events) == 0)
                <h3 class="text-center">No se encontrarón eventos...</h3>
              @else
        ...
        <div class="modal-body">
          <form id="ajaxForm" class="modal-form create" action="{{route('admin.calendar.store')}}" method="POST">
            ...
            <div class="form-group">
              ...
              <input name="title" class="form-control" placeholder="Ingrese un titulo" type="text" value="">
              <p id="errtitle" class="mb-0 text-danger em"></p>
            </div>
            <div class="form-group">
              <label for="">Periodo del evento **</label>
              <input type="text" name="datetimes" class="form-control ltr" placeholder="Ingrese el período del evento" autocomplete="off"/>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="ajaxEditForm" class="" action="{{route('admin.calendar.update')}}" method="POST">
            ...
            <div class="form-group">
              <label for="">Titulo **</label>
              <input id="intitle" name="title" class="form-control" placeholder="Ingrese un titulo" type="text" value="">
              <p id="eerrtitle" class="mb-0 text-danger em"></p>
            </div>
            <div class="form-group">
            <label for="">Periodo del evento **</label>
                <input type="text" name="edatetimes" class="form-control ltr" placeholder="Ingrese el período del evento"/>
