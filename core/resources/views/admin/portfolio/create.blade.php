...
<div class="page-header">
   <h4 class="page-title">Crear Portafolio</h4>
   <ul class="breadcrumbs">
      ...
      <li class="nav-item">
         <a href="#">Página del Portafolio</a>
      </li>
      <li class="separator">
         <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
         <a href="#">Crear Portafolio</a>
      </li>
   </ul>
</div>
<div class="row">
   <div class="col-md-12">
      <div class="card">
         <div class="card-header">
            <div class="card-title d-inline-block">Crear Portafolio</div>
               ...
               <div class="col-lg-6 offset-lg-3">
                     ...
                     <form class="mb-3 dm-uploader drag-and-drop-zone create-form" enctype="multipart/form-data" action="{{route('admin.portfolio.upload')}}" method="POST">
                        <div class="form-row px-2">
                           <div class="col-12 mb-2">
                              <label for=""><strong>Imagenes destacadas **</strong></label>
                           </div>
                  ...
                  <form id="ajaxForm" class="" action="{{route('admin.portfolio.store')}}" method="post">
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-6">
                           <div class="form-group">
                              <label for="">Número de seie **</label>
                              <input type="number" class="form-control ltr" name="serial_number" value="" placeholder="Ingrese un Número de seie">
                     ...
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="title" value="" placeholder="Ingresa un titulo">
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="client_name" value="" placeholder="Ingrese el nombre del cliente">
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="tags" value="" data-role="tagsinput" placeholder="Ingrese tags">
                     ...
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="form-group">
                              ...
                              <input id="startDate" type="text" class="form-control datepicker" name="start_date" value="" placeholder="Ingrese Fecha de inicio" autocomplete="off">
                        ...
                        <div class="col-lg-6">
                           <div class="form-group">
                              ...
                              <input id="submissionDate" type="text" class="form-control datepicker" name="submission_date" value="" placeholder="Ingrese el Día de entrega" autocomplete="off">
                     ...
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="form-group">
                              ...
                              <textarea class="form-control summernote" name="content" placeholder="Ingrese contenido" data-height="300"></textarea>
                     ...
                     <div class="form-group">
                        ...
                        <textarea class="form-control" name="meta_description" rows="5" placeholder="Ingresa meta descripciones"></textarea>
                     </div>
                  </form>
               </div>
            </div>
