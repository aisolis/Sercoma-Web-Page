...
@section('content')
  <div class="page-header">
    <h4 class="page-title">Editar PortaFolio</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">Página de Portafolio</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#">Editar PortaFolio</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">Editar Portafolio</div>
        ...
        <div class="card-body pt-5 pb-5">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              ...
              <div class="px-2">
                <label for="" class="mb-2"><strong>Imágenes del Slider **</strong></label>
                <div class="row">
                  <div class="col-12">
                ...
                <form class="mb-3 dm-uploader drag-and-drop-zone" enctype="multipart/form-data" action="{{route('admin.portfolio.uploadUpdate', $portfolio->id)}}" method="POST">
                  <div class="form-row px-2">
                    <div class="col-12 mb-2">
                      <label for=""><strong>Imágen destacada **</strong></label>
                    </div>
              ...
              <form id="ajaxForm" class="" action="{{route('admin.portfolio.update')}}" method="post">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="title" value="{{$portfolio->title}}" placeholder="Ingrese un titulo">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="client_name" value="{{$portfolio->client_name}}" placeholder="Ingrese el nombre del cliente">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="tags" value="{{$portfolio->tags}}" data-role="tagsinput" placeholder="ingresa tags">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input id="startDate" type="text" class="form-control datepicker" name="start_date" value="{{$portfolio->start_date}}" placeholder="Ingrese una Fecha de inicio" autocomplete="off">
                      <p id="errstart_date" class="mb-0 text-danger em"></p>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="">Día de entrega **</label>
                      <input id="submissionDate" type="text" class="form-control datepicker" name="submission_date" value="{{$portfolio->submission_date}}" placeholder="Ingrese el Día de entrega" autocomplete="off">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <select class="form-control ltr" name="status">
                        ...
                        <option value="In Progress" {{$portfolio->status == 'In Progress' ? 'selected' : ''}}>En progreso</option>
                        <option value="Completed" {{$portfolio->status == 'Completed' ? 'selected' : ''}}>Completado</option>
                      </select>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <p class="text-warning mb-0"><small>Cuanto mayor sea el número de serie, más tarde se mostrará la cartera.</small></p>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control summernote" name="content" rows="8" placeholder="Ingrese contenido" data-height="300">{{$portfolio->content}}</textarea>
                ...
                <div class="form-group">
                   ...
                   <input class="form-control" name="meta_keywords" value="{{$portfolio->meta_keywords}}" placeholder="Ingrese palabras clave" data-role="tagsinput">
                </div>
                <div class="form-group">
                   <label>Meta Descripciones</label>
                   <textarea class="form-control" name="meta_description" rows="5" placeholder="Ingrese mete descripciones">{{$portfolio->meta_description}}</textarea>
                </div>
              </form>
            </div>
          </div>
