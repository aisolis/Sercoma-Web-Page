...
@section('content')
  ...
  <div class="breadcrumb-area contact" style="background-image: url('{{asset('assets/front/img/' . $bs->breadcrumb)}}');background-size:cover;">
     <div class="container">
           ...
           <div class="col-lg-6">
              ...
              <form action="{{route('front.sendmail')}}" class="contact-form" method="POST">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6">
                       <div class="form-element">
                          <input name="Telefono" type="text" placeholder="{{__('Telefono')}}" required>
                       </div>
                       @if ($errors->has('Telefono'))
                         <p class="text-danger mb-0">{{$errors->first('Telefono')}}</p>
                       @endif
                    </div>
                    <div class="col-md-12">
                       <div class="form-element">
              ...
              <div class="map-wrapper">
                 ...
                 <div class="contact-infos">
                    ...
                    <div class="single-contact-info">
                       ...
                       <p>{{convertUtf8($bs->contact_mail)}}</p>
                    </div>
                 </div>
              </div>
           </div>
