...
class SsubcategoryController extends Controller
{
    ...
    public function store(Request $request) {
      ...
      Session::flash('success', '¡Subcategoría agregada con éxito!');
      return "success";
    }
    ...
    public function update(Request $request) {
      ...
      Session::flash('success', '¡Subcategoría actualizada con éxito!');
      return "success";
    }
    ...
    public function delete(Request $request) {
      ...
      Session::flash('success', '¡Subcategoría eliminada con éxito!');
      return back();
    }
}
