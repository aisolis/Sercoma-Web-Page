...
class ScategoryController extends Controller
{
    ...
    public function delete(Request $request)
    {
        ...
        Session::flash('success', '¡Se eliminó la categoría de servicio con éxito!');
        return back();
    }
    ...
    public function bulkDelete(Request $request)
    {
        ...
        foreach ($ids as $id) {
            $scategory = Scategory::findOrFail($id);
            if ($scategory->services()->count() > 0) {
                Session::flash('warning', 'Primero, elimine todos los servicios de las categorías seleccionadas.');
                return "success";
            }
        }
        ...
        Session::flash('success', '¡Categorías de servicio eliminadas con éxito!');
        return "success";
    }
}
