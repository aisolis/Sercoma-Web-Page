...
class PackageController extends Controller
{
    ...
    public function formstore(Request $request)
    {
        ...
        Session::flash('success', '¡Campo de entrada agregado con éxito!');
        return "success";
    }
    ...
    public function inputDelete(Request $request)
    {
        ...
        $input->delete();
        Session::flash('success', '¡Campo de entrada eliminado con éxito!');
        return back();
    }
    ...
    public function inputUpdate(Request $request)
    {
        ...
        Session::flash('success', '¡Campo de entrada actualizado con éxito!');
        return "success";
    }
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('success', '¡Paquete agregado con éxito!');
        return "success";
    }
    ...
    public function update(Request $request)
    {
        ...
        Session::flash('success', 'Paquete actualizado con éxito!');
        return "success";
    }
    ...
    public function bulkDelete(Request $request)
    {
        ...
        Session::flash('success', 'Paquetes eliminados con éxito!');
        return "success";
    }
    ...
    public function status(Request $request)
    {
        ...
        Session::flash('success', '¡El estado del pedido cambió correctamente!');
        return back();
    }
    ...
    public function mail(Request $request)
    {
        ...
        Session::flash('success', '¡El correo enviado con éxito!');
        return "success";
    }
    ...
    public function orderDelete(Request $request)
    {
        ...
        Session::flash('success', 'Orden de paquete eliminada con éxito!');
        return back();
    }
    ...
    public function bulkOrderDelete(Request $request)
    {
        ...
        Session::flash('success', '¡Pedidos borrados con éxito!');
        return "success";
    }
}
