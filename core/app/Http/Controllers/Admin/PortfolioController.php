...
class PortfolioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $messages = [
            ...
            'service_id.required' => 'se requiere servicio'
        ];
        ...
        Session::flash('success', '¡Portafolio agregado con éxito!');
        return "success";
    }
    ...
    public function update(Request $request)
    {
        ...
        Session::flash('success', '¡Portafolio actualizado con éxito!');
        return "success";
    }
    ...
    public function delete(Request $request)
    {
        ...
        Session::flash('success', '¡Portafolio eliminado con éxito!');
        return back();
    }
    ...
    public function bulkDelete(Request $request)
    {
        ...
        Session::flash('success', '¡Portafolios eliminados con éxito!');
        return "success";
    }
