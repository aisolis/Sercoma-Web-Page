...
class GalleryController extends Controller
{
    ...
    {
        $messages = [
            'gallery.required' => 'Se requiere imagen',
        ...
        Session::flash('success', 'Imagen añadida con éxito!');
        return "success";
    }
    ...
    public function update(Request $request)
    {
        ...
        Session::flash('success', 'Galería actualizada con éxito!');
        return "success";
    }
    ...
    public function delete(Request $request)
    {
        ...
        Session::flash('success', 'Imagen eliminada con éxito!');
        return back();
    }
