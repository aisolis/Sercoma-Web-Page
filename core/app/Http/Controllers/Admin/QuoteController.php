...
class QuoteController extends Controller
{
    ...
    public function inputDelete(Request $request)
    {
        ...
        $input->delete();
        Session::flash('success', '¡Campo de entrada eliminada con éxito!');
        return back();
    }
    ...
    public function status(Request $request)
    {
        ...
        Session::flash('success', '¡El estado cambió con éxito!');
        return back();
    }
    ...
    public function delete(Request $request)
    {
        ...
        Session::flash('success', '¡Solicitud de cotización eliminada con éxito!');
        return back();
    }
    ...
    public function bulkDelete(Request $request)
    {
        ...
        Session::flash('success', '¡Solicitudes de cotización eliminadas con éxito!');
        return "success";
    }
}
