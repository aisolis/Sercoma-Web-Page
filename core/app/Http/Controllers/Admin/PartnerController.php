...
class PartnerController extends Controller
{
                ...
                function ($attribute, $value, $fail) use ($img, $allowedExts) {
                    if (!empty($img)) {
                        ...
                        if (!in_array($ext, $allowedExts)) {
                            return $fail("Solo se permite la imagen png, jpg, jpeg, recomendamos formato svg para imagenes");
                        }
                    }
                },
            ],
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('success', 'socio añadido correctamente!');
        return "success";
    }
    ...
    public function update(Request $request)
    {
        ...
        Session::flash('success', '¡Socio actualizado con éxito!');
        return "success";
    }
