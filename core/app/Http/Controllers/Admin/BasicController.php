...
class BasicController extends Controller
{
    ...
    public function updatehomeversion(Request $request, $langid)
    {
        ...
        Session::flash('success', "$request->home_version tema activado con éxito!");
        return back();
    }
    ...
    public function updatebasicinfo(Request $request, $langid)
    {
        ...
        Session::flash('success', '¡Información básica actualizada con éxito!');
        return back();
    }
    ...
    public function updateseo(Request $request, $langid)
    {
        ...
        Session::flash('success', 'Información SEO actualizada con éxito!');
        return back();
    }
    ...
    public function updatesupport(Request $request, $langid)
    {
        ...
        Session::flash('success', 'Información de soporte actualizada con éxito!');
        return back();
    }
    ...
    {
        $request->validate([
            'service_title' => 'required|max:50',
            'service_subtitle' => 'required|max:70',
            'career_title' => 'required|max:50',
            'career_subtitle' => 'required|max:70',
            'event_calendar_title' => 'required|max:50',
            'event_calendar_subtitle' => 'required|max:70',
            'service_details_title' => 'required|max:80',
            'portfolio_title' => 'required|max:50',
            'portfolio_subtitle' => 'required|max:70',
            'portfolio_details_title' => 'required|max:50',
            'blog_details_title' => 'required|max:50',
            'contact_title' => 'required|max:50',
            'contact_subtitle' => 'required|max:70',
            'gallery_title' => 'required|max:50',
            'gallery_subtitle' => 'required|max:70',
            'team_title' => 'required|max:50',
            'team_subtitle' => 'required|max:70',
            'faq_title' => 'required|max:50',
            'faq_subtitle' => 'required|max:70',
            'pricing_title' => 'required|max:50',
            'pricing_subtitle' => 'required|max:70',
            'blog_title' => 'required|max:50',
            'blog_subtitle' => 'required|max:70',
            'quote_title' => 'required|max:50',
            'quote_subtitle' => 'required|max:70',
            'error_title' => 'required|max:50',
            'error_subtitle' => 'required|max:70',
        ]);
        ...
        Session::flash('success', 'Título de la página y subtítulos actualizados correctamente.');
        return back();
    }
    ...
    public function updatescript(Request $request)
    {
        ...
        Session::flash('success', 'Scripts actualizados con éxito!');
        return back();
    }
    ...
    public function updatemaintainance(Request $request)
    {
        ...
        Session::flash('success', '¡El modo de mantenimiento y la página se actualizaron correctamente!');
        return "success";
    }
    ...
    public function updateavaibility(Request $request, $langid)
    {
        ...
        Session::flash('success', '¡Disponibilidad de página actualizada con éxito!');
        return back();
    }
    ...
    public function updatesections(Request $request, $langid)
    {
        ...
        Session::flash('success', 'Seccion personaliza con éxito!');
        return back();
    }
    ...
    public function updatecookie(Request $request, $langid)
    {
        $request->validate([
            ...
            'cookie_alert_button_text' => 'required|max:30',
        ]);
        ...
        Session::flash('success', '¡Alerta de cookies actualizada correctamente!');
        return back();
    }
}
