...
class TestimonialController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('success', '¡Testimonio agregado con éxito!');
        return "success";
    }
    ...
    public function update(Request $request)
    {
        ...
        Session::flash('success', '¡Testimonio actualizado con éxito!');
        return "success";
    }
    ...
    {
        $request->validate([
            'testimonial_section_title' => 'required|max:30',
        ...
        Session::flash('success', '¡Texto actualizado con éxito!');
        return back();
    }
    ...
    public function delete(Request $request)
    {
        ...
        Session::flash('success', '¡Testimonio eliminado con éxito!');
        return back();
    }
}
