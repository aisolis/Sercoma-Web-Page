...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('success', '¡Idioma agregado con éxito!');
        return "success";
    }
    ...
    public function update(Request $request)
    {
        ...
        Session::flash('success', 'Idioma actualizado con éxito!');
        return "success";
    }
    ...
    public function editKeyword($id)
    {
        if ($id > 0) {
            ...
            if (empty($json)) {
                return back()->with('alert', 'Archivo no encontrado.');
            }
    ...
    public function updateKeyword(Request $request, $id)
    {
        ...
        if ($content === 'null') {
            return back()->with('alert', 'Al menos un campo debe ser llenado');
        }
    ...
    public function delete($id)
    {
        $la = Language::findOrFail($id);
        if ($la->is_default == 1) {
            return back()->with('warning', '¡El idioma predeterminado no se puede eliminar!');
        }
        ...
        $la->delete();
        return back()->with('success', 'Eliminar con éxito');
    }
    ...
    public function default(Request $request, $id)
    {
        ...
        $lang->is_default = 1;
        $lang->save();
        return back()->with('success', $lang->name . ' el idioma se establece como predeterminado.');
    }
